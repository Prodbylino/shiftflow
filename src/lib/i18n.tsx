...
const translations: Translations = {
  ...
  'analytics.financialYear': { en: 'Financial Year 24-25', zh: '财年 24-25' },
  ...
  'analytics.monthlyTrend': { en: 'Monthly Hours Trend (FY 2024-25)', zh: '月度工时趋势 (财年 2024-25)' },
  'analytics.detailedBreakdown': { en: 'Detailed Breakdown', zh: '详细分类' },
  'analytics.exportCSV': { en: 'Export CSV', zh: '导出 CSV' },
  'analytics.basedOnWeeks': { en: 'Based on last 4 weeks', zh: '基于过去4周' },
